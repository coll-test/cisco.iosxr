...
class TestIosxrSystemModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.cisco.iosxr.plugins.modules.iosxr_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.cisco.iosxr.plugins.modules.iosxr_system.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_is_cliconf = patch('ansible_collections.cisco.iosxr.plugins.modules.iosxr_system.is_cliconf')
