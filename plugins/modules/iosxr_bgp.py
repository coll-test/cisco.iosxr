...
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.providers.module import NetworkModule
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
