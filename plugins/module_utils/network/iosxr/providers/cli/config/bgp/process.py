...
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.providers.providers import register_provider
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.providers.providers import CliProvider
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.providers.cli.config.bgp.neighbors import Neighbors
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.providers.cli.config.bgp.address_family import AddressFamily
