...
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.utils.utils import normalize_interface, dict_to_set
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.utils.utils import remove_command_from_config_list, add_command_to_config_list
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.utils.utils import filter_dict_having_none_value, remove_duplicate_interface
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.utils.utils import validate_n_expand_ipv4, validate_ipv6
