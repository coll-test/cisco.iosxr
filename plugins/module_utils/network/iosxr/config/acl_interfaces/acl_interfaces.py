...
from ansible_collections.cisco.iosxr.plugins.module_utils.network.iosxr.utils.utils import normalize_interface, diff_list_of_dicts, pad_commands
from ansible_collections.ansible.netcommon.plugins.module_utils.network.common.utils \
    import (
        to_list,
        search_obj_in_list,
        remove_empties
